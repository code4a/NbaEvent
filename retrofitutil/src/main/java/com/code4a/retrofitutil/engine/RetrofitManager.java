...
public final class RetrofitManager {
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription getStringRequest(String path, Subscriber<String> subscriber) {
        return getStringRequest(path, new HashMap<String, Object>(), subscriber);
    }
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription getStringRequest(String path, @NonNull Map<String, Object> paramMap, Subscriber<String> subscriber) {
        return doSubscribe(create(BaseService.class)
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription getResponseBodyRequest(String path, Subscriber<ResponseBody> subscriber) {
        return getResponseBodyRequest(path, new HashMap<String, Object>(), subscriber);
    }
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription getResponseBodyRequest(String path, @NonNull Map<String, Object> paramMap, Subscriber<ResponseBody> subscriber) {
        return doIoSubscribe(create(BaseService.class)
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription postStringRequest(String path, RequestBody requestBody, Subscriber<String> subscriber) {
        return postStringRequest(path, new HashMap<String, Object>(), requestBody, subscriber);
    }
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription postStringRequest(String path, @NonNull Map<String, Object> paramMap, RequestBody requestBody, Subscriber<String> subscriber) {
        return doSubscribe(create(BaseService.class)
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription postResponseBodyRequest(String path, RequestBody requestBody, Subscriber<ResponseBody> subscriber) {
        return postResponseBodyRequest(path, new HashMap<String, Object>(), requestBody, subscriber);
    }
     ...
     * @return 订阅者，可用于取消事件
     */
    public Subscription postResponseBodyRequest(String path, @NonNull Map<String, Object> paramMap, RequestBody requestBody, Subscriber<ResponseBody> subscriber) {
        return doIoSubscribe(create(BaseService.class)
     ...
     * @return 订阅者，可用于取消事件
     */
    public <T> Subscription doComposeSubscribe(Observable<? extends ResponseBase<T>> observable, RxSubscriber<T> rxSubscriber) {
        return observable
